...
typedef
    ccs_design::HDL::des_check ccs_DUT_wrapper;
...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_in<sc_lv<64> > input_rsc_dat;
  sc_out<sc_logic> input_rsc_triosy_lz;
  sc_in<sc_lv<64> > key_rsc_dat;
  sc_out<sc_logic> key_rsc_triosy_lz;
  sc_out<sc_lv<64> > return_rsc_dat;
