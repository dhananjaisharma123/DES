...
//  
//  Running on Linux ds6365@hansolo.poly.edu 3.10.0-1127.18.2.el7.x86_64 x86_64 aol
//  
...
solution options set /Flows/SCVerify/QUESTASIM_DEBUG true
solution options set /Flows/SCVerify/USE_CCS_BLOCK true
solution file add ./des_tb.cpp -type C++ -exclude true
solution file add ./des_fun.h -type CHEADER
